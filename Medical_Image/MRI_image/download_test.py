...
base_url = "https://www.cs.toronto.edu/~vmnih/data/mass_roads/test/sat/index.html"

# Create the 'test_images' directory to save images
...
for link in soup.find_all("a"):
    ...
    if file_name.endswith((".jpg", ".png", ".tiff"))
        ...
        with open(f"test_images/{actual_file_name}", "wb") as img_file:
